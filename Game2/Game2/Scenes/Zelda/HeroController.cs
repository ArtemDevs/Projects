...
namespace Game2
{
    public class HeroController : Component, ITriggerListener, IUpdatable
    {
        enum Animations
        {
            WalkUp,
        ...
        {
            var texture = entity.scene.content.Load<Texture2D>("Zelda/characters/2");
        ...
        void IUpdatable.update()
        {
            ...
            if (_fireInput.isPressed)
            {
                ...
                var ninjaScene = entity.scene as WorldScene;
